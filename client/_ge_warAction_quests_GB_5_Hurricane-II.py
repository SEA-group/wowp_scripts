# Embedded file name: scripts/client/_ge_warAction_quests_GB_5_Hurricane-II.py
"""
...
DB.header.server.price.prolong.tickets = 4
...
DB.subscriber[0].nested.subscriber[0].client.description.locale = 'LOBBY_QUESTS_EVENT_2017_TEXT_2'
DB.subscriber[0].nested.subscriber[0].client.name = Dummy()
DB.subscriber[0].nested.subscriber[0].client.name.locale = 'LOBBY_QUESTS_2016_DAILY_013_NAME'
...
DB.subscriber[0].nested.subscriber[0].server.price.buy.tickets = 6
...
DB.subscriber[0].nested.subscriber[1].client.description.locale = 'LOBBY_QUESTS_2016_DAILY_061'
DB.subscriber[0].nested.subscriber[1].client.name = Dummy()
DB.subscriber[0].nested.subscriber[1].client.name.locale = 'LOBBY_QUESTS_2016_DAILY_061_NAME'
...
DB.subscriber[0].nested.subscriber[1].server.price.buy.tickets = 10
...
DB.subscriber[0].nested.subscriber[2].client.description.locale = 'LOBBY_QUESTS_EVENT_2017_TEXT_3'
DB.subscriber[0].nested.subscriber[2].client.name = Dummy()
DB.subscriber[0].nested.subscriber[2].client.name.locale = 'LOBBY_QUESTS_2016_DAILY_014_NAME'
...
DB.subscriber[0].nested.subscriber[2].event[0].count[0].value_ = 18
...
DB.subscriber[0].nested.subscriber[2].server.price.buy.tickets = 14
DB.subscriber[0].nested.subscriber[2].server.scope = []
DB.subscriber[0].operation = []
DB.subscriber[0].send = []
DB.subscriber[0].id = -890650262
DB.subscriber[0].nested.subscriber[0].id = -2028043936
DB.subscriber[0].nested.subscriber[1].id = 519890785
DB.subscriber[0].nested.subscriber[2].id = -546162527
DB.subscriber[0].nested.subscriber[0].eventIds = (-1405083736, 761754430)
DB.subscriber[0].nested.subscriber[2].eventIds = (-1405083736, 761754430)
DB.subscriber[0].nested.subscriber[1].eventIds = (771950333,)
DB.subscriber[0].nested.subscriber[0].parent = -890650262
DB.subscriber[0].nested.subscriber[1].parent = -890650262
DB.subscriber[0].nested.subscriber[2].parent = -890650262
mapping = {'db': DB,
 'indexes': {'subscriber': {'id': {-890650262: (DB.subscriber[0],),
                                   -2028043936: (DB.subscriber[0].nested.subscriber[0],),
                                   519890785: (DB.subscriber[0].nested.subscriber[1],),
                                   -546162527: (DB.subscriber[0].nested.subscriber[2],)},
                            'name': {'Hurricane-II': (DB.subscriber[0],),
                            ...
                            'group': {'warAction': (DB.subscriber[0],
                                                    ...
                                                    DB.subscriber[0].nested.subscriber[1],
                                                    DB.subscriber[0].nested.subscriber[2])},
                            'eventIds': {(-1405083736, 761754430): (DB.subscriber[0].nested.subscriber[0], DB.subscriber[0].nested.subscriber[2]),
                                         (771950333,): (DB.subscriber[0].nested.subscriber[1],)},
                            'parent': {-890650262: (DB.subscriber[0].nested.subscriber[0], DB.subscriber[0].nested.subscriber[1], DB.subscriber[0].nested.subscriber[2])}}},
