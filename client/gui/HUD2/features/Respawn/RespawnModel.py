...
class RespawnModel(AutoFilledDataModel):
    ...
    SCHEME = Structure(timeToRespawnPossibility=IntT, timeToAutoRespawn=IntT, respawnAmount=IntT, deathTime=IntT, respawnUnlimited=BoolT, respawnIsAvailableBySector=BoolT, selectedPlaneID=IntT, spawnSectorID=StringT, planes=List(RespawnPlaneData), changeRespawnTimeData=DictT)