...
class PlayerInfoModel(AutoFilledDataModel):
    ...
    SCHEME = Structure(clanName=UnicodeT, nickName=UnicodeT, planeName=UnicodeT, planeType=IntT, planeGlobalID=IntT, planeLevel=IntT, squadIndex=IntT, teamIndex=IntT, id=IntT, state=IntT, rank=IntT, planeScoresData=List(planeScoreData))