...
class RootSettingsPreserver(BasePreserver):
    ...
    def __prepareGameSettings(self, gameS):
        ...
        gameS['heightMode'] = BaseListener()
        gameS['heightMode']['index'] = GameUISettingsPreserver('heightMode')
        ...
        for fKey, sKey in GAME_SETTINGS_MAIN_DATA.iteritems():
            gameS[fKey] = SettingsMainPreserver(sKey)

        gameS['lobbySettings'] = BaseListener()
        gameS['lobbySettings']['hangar'] = HungarTypePreserver()
        gameS['radarSettings'] = BaseListener()
        gameS['radarSettings']['radarState'] = BaseListener()
        gameS['radarSettings']['radarState']['index'] = GameUISettingsPreserver('radarState')
        gameS['radarSettings']['radarSize'] = BaseListener()
        gameS['radarSettings']['radarSize']['index'] = GameUISettingsPreserver('radarSize')
        gameS['radarSettings']['radarLockRotation'] = BaseListener()
        gameS['radarSettings']['radarLockRotation']['index'] = GameUISettingsPreserver('radarLockRotation')
        gameS['radarSettings']['showDefendersActive'] = GameUISettingsPreserver('showDefendersActive')
        gameS['attitudeIndicatorSettings'] = BaseListener()
        gameS['attitudeIndicatorSettings']['attitudeMode'] = BaseListener()
        gameS['attitudeIndicatorSettings']['attitudeMode']['index'] = GameUISettingsPreserver('attitudeMode')
