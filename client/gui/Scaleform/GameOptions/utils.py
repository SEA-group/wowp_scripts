...
DEVICES_MAIN_UI_DATA = {'playerList': 'players',
 ...
 'aviaHorizon': 'horizon'}
GENERAL_MAIN_UI_DATA = {'alternativeColorMode': 'alternativeColorMode',
 'isSniperMode': 'isSniperMode'}
GENERAL_MAIN_SETTINGS_DATA = {'cinemaCamera': 'cinemaCamera',
...
GAME_SETTINGS_MAIN_DATA = {'blockWinButton': 'blockWinButton',
