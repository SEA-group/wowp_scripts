# Embedded file name: scripts/client/_ge_warAction_quests_GB_6_Tornado.py
"""
...
DB.header.server.price.prolong.tickets = 6
...
DB.subscriber[0].nested.subscriber[0].client.description.locale = 'LOBBY_QUESTS_2016_DAILY_018'
DB.subscriber[0].nested.subscriber[0].client.name = Dummy()
DB.subscriber[0].nested.subscriber[0].client.name.locale = 'LOBBY_QUESTS_2016_DAILY_018_NAME'
...
DB.subscriber[0].nested.subscriber[0].server.price.buy.tickets = 15
...
DB.subscriber[0].nested.subscriber[1].client.description.locale = 'LOBBY_QUESTS_EVENT_2017_TEXT_4'
...
DB.subscriber[0].nested.subscriber[1].event[0].condition[0].in_.insert(0, None)
DB.subscriber[0].nested.subscriber[1].event[0].condition[0].in_[0] = Dummy()
DB.subscriber[0].nested.subscriber[1].event[0].condition[0].in_[0].context = []
DB.subscriber[0].nested.subscriber[1].event[0].condition[0].in_[0].context.insert(0, None)
DB.subscriber[0].nested.subscriber[1].event[0].condition[0].in_[0].context[0] = 'victim.plane.type'
DB.subscriber[0].nested.subscriber[1].event[0].condition[0].in_[0].value_ = []
DB.subscriber[0].nested.subscriber[1].event[0].condition[0].in_[0].value_.insert(0, None)
DB.subscriber[0].nested.subscriber[1].event[0].condition[0].in_[0].value_[0] = 'assault'
DB.subscriber[0].nested.subscriber[1].event[0].condition[0].in_[0].value_.insert(1, None)
DB.subscriber[0].nested.subscriber[1].event[0].condition[0].in_[0].value_[1] = 'bomber'
...
DB.subscriber[0].nested.subscriber[1].event[0].count[0].value_ = 100
...
DB.subscriber[0].nested.subscriber[1].server.price.buy.tickets = 25
...
DB.subscriber[0].nested.subscriber[2].client.description.locale = 'LOBBY_QUESTS_EVENT_2017_TEXT_5'
...
DB.subscriber[0].nested.subscriber[2].event[0].context = 'marcel.epic'
...
DB.subscriber[0].nested.subscriber[2].event[0].name = 'completed'
DB.subscriber[0].nested.subscriber[2].event[0].operation = []
DB.subscriber[0].nested.subscriber[2].event[0].type = 'achievement'
...
DB.subscriber[0].nested.subscriber[2].server.price.buy.tickets = 35
DB.subscriber[0].nested.subscriber[2].server.scope = []
DB.subscriber[0].operation = []
DB.subscriber[0].send = []
DB.subscriber[0].id = -1142624717
DB.subscriber[0].nested.subscriber[0].id = 1272914945
DB.subscriber[0].nested.subscriber[1].id = -767737344
DB.subscriber[0].nested.subscriber[2].id = 330538432
DB.subscriber[0].nested.subscriber[0].eventIds = (-104890988, 761754430)
DB.subscriber[0].nested.subscriber[1].eventIds = (-104890988,)
DB.subscriber[0].nested.subscriber[2].eventIds = (774143625,)
DB.subscriber[0].nested.subscriber[0].parent = -1142624717
DB.subscriber[0].nested.subscriber[1].parent = -1142624717
DB.subscriber[0].nested.subscriber[2].parent = -1142624717
mapping = {'db': DB,
 'indexes': {'subscriber': {'id': {-1142624717: (DB.subscriber[0],),
                                   1272914945: (DB.subscriber[0].nested.subscriber[0],),
                                   -767737344: (DB.subscriber[0].nested.subscriber[1],),
                                   330538432: (DB.subscriber[0].nested.subscriber[2],)},
                            'name': {'Tornado': (DB.subscriber[0],),
                            ...
                            'group': {'warAction': (DB.subscriber[0],
                                                    ...
                                                    DB.subscriber[0].nested.subscriber[1],
                                                    DB.subscriber[0].nested.subscriber[2])},
                            'eventIds': {(-104890988, 761754430): (DB.subscriber[0].nested.subscriber[0],),
                                         (-104890988,): (DB.subscriber[0].nested.subscriber[1],),
                                         (774143625,): (DB.subscriber[0].nested.subscriber[2],)},
                            'parent': {-1142624717: (DB.subscriber[0].nested.subscriber[0], DB.subscriber[0].nested.subscriber[1], DB.subscriber[0].nested.subscriber[2])}}},
