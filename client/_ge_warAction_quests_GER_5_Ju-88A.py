# Embedded file name: scripts/client/_ge_warAction_quests_GER_5_Ju-88A.py
"""
...
DB.subscriber[0].nested.subscriber[0].client.description.locale = 'LOBBY_QUESTS_2016_DAILY_046'
DB.subscriber[0].nested.subscriber[0].client.name = Dummy()
DB.subscriber[0].nested.subscriber[0].client.name.locale = 'LOBBY_QUESTS_2016_DAILY_046_NAME'
...
DB.subscriber[0].nested.subscriber[1].client.name.locale = 'LOBBY_QUESTS_2016_DAILY_068_NAME'
...
DB.subscriber[0].nested.subscriber[1].event[0].count[0].value_ = 200
...
DB.subscriber[0].nested.subscriber[2].client.description.locale = 'LOBBY_QUESTS_EVENT_2017_TEXT_6'
DB.subscriber[0].nested.subscriber[2].client.name = Dummy()
DB.subscriber[0].nested.subscriber[2].client.name.locale = 'LOBBY_QUESTS_2016_DAILY_032_NAME'
...
DB.subscriber[0].nested.subscriber[2].event[0].count[0].value_ = 5
DB.subscriber[0].nested.subscriber[2].event[0].name = 'sector.capture.participated'
...
DB.subscriber[0].id = -145202352
DB.subscriber[0].nested.subscriber[0].id = 1095023677
DB.subscriber[0].nested.subscriber[1].id = -660153796
DB.subscriber[0].nested.subscriber[2].id = 422053372
...
DB.subscriber[0].nested.subscriber[2].eventIds = (-1597458317, 761754430)
DB.subscriber[0].nested.subscriber[0].parent = -145202352
DB.subscriber[0].nested.subscriber[1].parent = -145202352
DB.subscriber[0].nested.subscriber[2].parent = -145202352
mapping = {'db': DB,
 'indexes': {'subscriber': {'id': {-145202352: (DB.subscriber[0],),
                                   1095023677: (DB.subscriber[0].nested.subscriber[0],),
                                   -660153796: (DB.subscriber[0].nested.subscriber[1],),
                                   422053372: (DB.subscriber[0].nested.subscriber[2],)},
                            'name': {'Ju-88A': (DB.subscriber[0],),
                            ...
                            'eventIds': {(-1370837730, 761754430, 615894436): (DB.subscriber[0].nested.subscriber[0],),
                                         ...
                                         (-1597458317, 761754430): (DB.subscriber[0].nested.subscriber[2],)},
                            'parent': {-145202352: (DB.subscriber[0].nested.subscriber[0], DB.subscriber[0].nested.subscriber[1], DB.subscriber[0].nested.subscriber[2])}}},
