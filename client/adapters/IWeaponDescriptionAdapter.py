...
from Helpers.iconPathHelper import get24ModuleIconPath, get48ModuleIconPath, ICON_MODULE_DEFAULT_PATH
import consts
    ...
    def __call__(self, account, ob, **kw):
        ...
        if weapon is None:
            ...
            if upgrade is not None:
                adaptedOB['iconPath'] = get48ModuleIconPath(getattr(upgrade, 'iconPath', ICON_MODULE_DEFAULT_PATH))
                adaptedOB['iconPathSmall'] = get24ModuleIconPath(getattr(upgrade, 'iconPath', ICON_MODULE_DEFAULT_PATH))
