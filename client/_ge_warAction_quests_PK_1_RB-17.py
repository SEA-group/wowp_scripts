# Embedded file name: scripts/client/_ge_warAction_quests_PK_1_RB-17.py
"""
...
DB.subscriber[0].nested.subscriber[0].client.description.locale = 'MEDAL_DESCRIPTION_THUNDER'
DB.subscriber[0].nested.subscriber[0].client.name = Dummy()
DB.subscriber[0].nested.subscriber[0].client.name.locale = 'TOOLTIPS_QUESTS_2015_AUTUMN_015_NAME'
...
DB.subscriber[0].nested.subscriber[0].event[0].condition[0].equal[0].value_[0] = 'ground'
...
DB.subscriber[0].nested.subscriber[0].event[0].count[0].context = 'points.capture'
DB.subscriber[0].nested.subscriber[0].event[0].count[0].display = true
DB.subscriber[0].nested.subscriber[0].event[0].count[0].id = 0
DB.subscriber[0].nested.subscriber[0].event[0].count[0].value_ = 500
...
DB.subscriber[0].nested.subscriber[1].client.description.locale = 'LOBBY_QUESTS_2016_DAILY_068'
...
DB.subscriber[0].nested.subscriber[1].event[0].condition[0].equal[0].value_[0] = 'antiair'
...
DB.subscriber[0].nested.subscriber[1].event[0].count[0].value_ = 240
DB.subscriber[0].nested.subscriber[1].event[0].name = 'part.destroy'
...
DB.subscriber[0].nested.subscriber[2].client.description.locale = 'MEDAL_DESCRIPTION_DULITTLA'
DB.subscriber[0].nested.subscriber[2].client.name = Dummy()
DB.subscriber[0].nested.subscriber[2].client.name.locale = 'LOBBY_QUESTS_2016_DAILY_030_NAME'
...
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_.insert(0, None)
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0] = Dummy()
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].and_ = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].contains = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal.insert(0, None)
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[0] = Dummy()
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[0].context = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[0].context.insert(0, None)
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[0].context[0] = 'victim.object'
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[0].value_ = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[0].value_.insert(0, None)
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[0].value_[0] = 'ground'
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal.insert(1, None)
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[1] = Dummy()
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[1].context = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[1].context.insert(0, None)
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[1].context[0] = 'player.plane.type'
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[1].value_ = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[1].value_.insert(0, None)
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].equal[1].value_[0] = 'bomber'
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].gt = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].gte = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].id = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].in_ = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].lt = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].lte = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].not_ = []
DB.subscriber[0].nested.subscriber[2].event[0].condition[0].and_[0].or_ = []
...
DB.subscriber[0].nested.subscriber[2].event[0].count[0].context = 'points.capture'
DB.subscriber[0].nested.subscriber[2].event[0].count[0].display = true
DB.subscriber[0].nested.subscriber[2].event[0].count[0].id = 0
DB.subscriber[0].nested.subscriber[2].event[0].count[0].value_ = 400
...
DB.subscriber[0].id = 1406263386
DB.subscriber[0].nested.subscriber[0].id = 2008120260
DB.subscriber[0].nested.subscriber[1].id = -296542779
DB.subscriber[0].nested.subscriber[2].id = 803062277
DB.subscriber[0].nested.subscriber[0].eventIds = (771950333, 761754430)
DB.subscriber[0].nested.subscriber[1].eventIds = (151230433,)
DB.subscriber[0].nested.subscriber[2].eventIds = (771950333, 615894436)
DB.subscriber[0].nested.subscriber[0].parent = 1406263386
DB.subscriber[0].nested.subscriber[1].parent = 1406263386
DB.subscriber[0].nested.subscriber[2].parent = 1406263386
mapping = {'db': DB,
 'indexes': {'subscriber': {'id': {1406263386: (DB.subscriber[0],),
                                   2008120260: (DB.subscriber[0].nested.subscriber[0],),
                                   -296542779: (DB.subscriber[0].nested.subscriber[1],),
                                   803062277: (DB.subscriber[0].nested.subscriber[2],)},
                            'name': {'RB-17': (DB.subscriber[0],),
                            ...
                            'eventIds': {(771950333, 761754430): (DB.subscriber[0].nested.subscriber[0],),
                                         (151230433,): (DB.subscriber[0].nested.subscriber[1],),
                                         (771950333, 615894436): (DB.subscriber[0].nested.subscriber[2],)},
                            'parent': {1406263386: (DB.subscriber[0].nested.subscriber[0], DB.subscriber[0].nested.subscriber[1], DB.subscriber[0].nested.subscriber[2])}}},
