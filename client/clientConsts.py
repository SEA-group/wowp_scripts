...
MIN_TARGET_SIZE = 0.0
TARGET_DISP_IDENTITY_CFC = 0.7
CLAMP_MAX_TARGET_SIZE = 0.9
CLAMP_MIN_TARGET_SIZE = 0.45
WEAPON_OVERHEAT_DELTA = 0.7
MAX_PULSATION_LENGTH = 4
SNIPER_SHAKE_LENGTH = 5
PULSATION_MIN = 0.1
PULSATION_MAX = 0.9
SNIPER_SCOPE_MAX_SIZE = 10
SNIPER_SCOPE_COEF = 3.0
...
LOC_HINT_PLANE_TASK = {PLANE_TYPE.FIGHTER: 'hint_fighter_1',
 ...
 PLANE_TYPE.BOMBER: 'hint_bomber_1'}
...
ACTIONMATCHER_ANIMATION_DISTANCE = 300.0 * WORLD_SCALING
...
PREBATTLE_PLANE_TYPE_NAME = {PLANE_TYPE.FIGHTER: 'PREBATTLE_PLANE_TYPE_FIGHTER',
 ...
 PLANE_TYPE.BOMBER: 'PREBATTLE_PLANE_TYPE_BOMBER'}
...
class PLANE_TYPE_ICO_PATH:
    ...
    HUD_TEMPLATE = 'icons/hud/carousel/classIcons/iconCarousel%s%s.png'

    @staticmethod
    def iconHud(planeType, planeStatus):
        return PLANE_TYPE_ICO_PATH.HUD_TEMPLATE % (PLANE_TYPE_ICO_PATH.PLANE_TYPE_DICT[planeType], PLANE_TYPE_ICO_PATH.PLANE_CLASS_DICT[planeStatus])
...
class PLANE_TYPE_BATTLE_RESULT_ICO_PATH:
    PLANE_TYPE_DICT = {PLANE_TYPE.FIGHTER: 'hudTypeFighter_Color.png',
     ...
     PLANE_TYPE.NAVY: 'hudTypeMarine_Color.png',
     PLANE_TYPE.BOMBER: 'hudTypeBomber_Color.png'}
...
BATTLE_DESC_BY_TYPE_HUD_LOC_ID = {ARENA_TYPE.NORMAL: 'lobby_game_type_description_areaconquest',
 ...
 ARENA_TYPE.JAPANESE_THREAT: 'LOBBY_BATTLE_SINGLE_FLIGHT_DESCRIPTION_ALBION_EVENT'}
...
SPEED_IDLE_EFFECT_START_COEF = 0.45
SPEED_IDLE_EFFECT_END_COEF = 0.9
SPEED_EFFECT_DIVIDE_COEF = 1200.0
SPEED_UPDATE_STEP = 5.0
...
class CAMERA_ZOOM_PRESET:
    ...
    DIRECT_GUNNER = 'directGunner'
    DIRECT_SNIPER = 'directSniper'
    DEFAULT = DIRECT_COMBAT
...
class TARGET_PARTS_TYPES:
    ...
    ARMORED_FIRING_HIGH = 5
    NOT_ARMORED_FIRING_HIGH = 6
...
class PREBATTLE_BOT_DIFFICULTY:
    ICON_PATH_MAP = {BOT_DIFFICULTY.LOW: 'icons/hangarCarousel/filtrIcons/filtrLevelBotBeginner_over.dds',
     BOT_DIFFICULTY.MEDIUM: 'icons/hangarCarousel/filtrIcons/filtrLevelBotWarrior_over.dds',
     BOT_DIFFICULTY.HIGH: 'icons/hangarCarousel/filtrIcons/filtrLevelBotVeteran_over.dds'}
...
SPEED_OVERLOAD_MIN = 80.0
SPEED_OVERLOAD_MAX = 100.0
FLAPS_EFFECTS_ONLY_ON_ENGINE_OFF = True
SENSITIVITY_SNIPER_MODE_MULTIPLIER = 0.5
SENSITIVITY_OVERVIEW_MODE_MULTIPLIER = 1.75
NORMAL_GUNS_RPM = 900.0

class FAKE_ROTATION_LOCKS:
    FREE_CAMERA = 1
    IN_GAME_STATE = 2
...
class SPECTATOR_TYPE:
    NONE = 0
    CINEMATIC = 1
    AUTO_TACTICAL = 2
    CONTROLLED_TACTICAL = 4
    TACTICAL = AUTO_TACTICAL


class HANGAR_VISUAL_EVENT:
    EVENT_NAME = 'HANGAR_VISUAL'
    VSE_NAME = 'onHangarVisualEvent'