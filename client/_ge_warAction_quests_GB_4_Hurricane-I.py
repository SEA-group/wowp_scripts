# Embedded file name: scripts/client/_ge_warAction_quests_GB_4_Hurricane-I.py
"""
...
DB.subscriber[0].client.name.locale = 'LOBBY_REWARD_SPECIAL_QUEST_HURRICANE-I'
...
DB.subscriber[0].nested.subscriber[1].client.description.locale = 'LOBBY_QUESTS_2016_DAILY_014'
...
DB.subscriber[0].nested.subscriber[2].event[0].context = 'ace.heroic'
...
DB.subscriber[0].nested.subscriber[2].eventIds = (-1476813203,)
...
mapping = {'db': DB,
 'indexes': {'subscriber': {'id': {1653620256: (DB.subscriber[0],),
                            ...
                            'eventIds': {(771950333, 761754430): (DB.subscriber[0].nested.subscriber[0],),
                                         ...
                                         (-1476813203,): (DB.subscriber[0].nested.subscriber[2],)},
