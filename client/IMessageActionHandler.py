...
from Helpers.i18n import localizeMessages, getFormattedTime, localizeChat
...
def resbattle(imsg):
    ...
    msgData = imsg['msgData']
    for planeID in msgData['planes']:
        BWPersonality.g_lobbyCarouselHelper.updatePlaneAfterBattle(planeID)
