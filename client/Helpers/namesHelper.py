...
INFO_ICO_PATH = 'icons/pilots/info/%s/%s/pilot_%02d.dds'
CREW_ICO_PATH = 'icons/pilots/crew/%s/%s/pilot_%02d.dds'
MINI_ICO_PATH = 'icons/pilots/mini/%s/%s/pilot_%02d.dds'
