# Embedded file name: scripts/client/_ge_warAction_quests_Hurricane-I.py
"""
...
DB.header.nested.subscriber[0].server.available = true
DB.header.nested.subscriber[0].server.price = Dummy()
DB.header.nested.subscriber[0].server.price.buy = Dummy()
DB.header.nested.subscriber[0].server.price.buy.tickets = 5
...
DB.subscriber[0].name = 'Hurricane-I'
...
DB.subscriber[0].nested.subscriber[0].client.description.locale = 'LOBBY_QUESTS_2016_DAILY_062'
DB.subscriber[0].nested.subscriber[0].client.name = Dummy()
DB.subscriber[0].nested.subscriber[0].client.name.locale = 'LOBBY_QUESTS_2016_DAILY_062_NAME'
...
DB.subscriber[0].nested.subscriber[0].condition[0].gte.insert(0, None)
DB.subscriber[0].nested.subscriber[0].condition[0].gte[0] = Dummy()
DB.subscriber[0].nested.subscriber[0].condition[0].gte[0].context = []
DB.subscriber[0].nested.subscriber[0].condition[0].gte[0].context.insert(0, None)
DB.subscriber[0].nested.subscriber[0].condition[0].gte[0].context[0] = 'player.plane.level'
DB.subscriber[0].nested.subscriber[0].condition[0].gte[0].value_ = []
DB.subscriber[0].nested.subscriber[0].condition[0].gte[0].value_.insert(0, None)
DB.subscriber[0].nested.subscriber[0].condition[0].gte[0].value_[0] = '4'
...
DB.subscriber[0].nested.subscriber[0].event[0].count[0].value_ = 2500
...
DB.subscriber[0].nested.subscriber[1].client.description.locale = 'LOBBY_QUESTS_2016_DAILY_062'
DB.subscriber[0].nested.subscriber[1].client.name = Dummy()
DB.subscriber[0].nested.subscriber[1].client.name.locale = 'LOBBY_QUESTS_2016_DAILY_014_NAME'
...
DB.subscriber[0].nested.subscriber[1].event[0].count[0].value_ = 300
...
DB.subscriber[0].nested.subscriber[2].client.description.locale = 'LOBBY_QUESTS_EVENT_2017_TEXT_1'
...
DB.subscriber[0].id = 1653620256
DB.subscriber[0].nested.subscriber[0].id = -594747937
DB.subscriber[0].nested.subscriber[1].id = 1164884958
DB.subscriber[0].nested.subscriber[2].id = -2065669090
DB.subscriber[0].nested.subscriber[0].eventIds = (771950333, 761754430)
DB.subscriber[0].nested.subscriber[1].eventIds = (-1405083736,)
DB.subscriber[0].nested.subscriber[2].eventIds = (-104890988, 761754430)
DB.subscriber[0].nested.subscriber[0].parent = 1653620256
DB.subscriber[0].nested.subscriber[1].parent = 1653620256
DB.subscriber[0].nested.subscriber[2].parent = 1653620256
mapping = {'db': DB,
 'indexes': {'subscriber': {'id': {1653620256: (DB.subscriber[0],),
                                   -594747937: (DB.subscriber[0].nested.subscriber[0],),
                                   1164884958: (DB.subscriber[0].nested.subscriber[1],),
                                   -2065669090: (DB.subscriber[0].nested.subscriber[2],)},
                            'name': {'Hurricane-I': (DB.subscriber[0],),
                            ...
                            'eventIds': {(771950333, 761754430): (DB.subscriber[0].nested.subscriber[0],),
                                         (-1405083736,): (DB.subscriber[0].nested.subscriber[1],),
                                         (-104890988, 761754430): (DB.subscriber[0].nested.subscriber[2],)},
                            'parent': {1653620256: (DB.subscriber[0].nested.subscriber[0], DB.subscriber[0].nested.subscriber[1], DB.subscriber[0].nested.subscriber[2])}}},
