# Embedded file name: scripts/client/_ge_warAction_quests_GER_6_Do-217M.py
"""
...
DB.subscriber[0].nested.subscriber[0].client.description.locale = 'LOBBY_QUESTS_2016_DAILY_092'
DB.subscriber[0].nested.subscriber[0].client.name = Dummy()
DB.subscriber[0].nested.subscriber[0].client.name.locale = 'LOBBY_QUESTS_2016_DAILY_092_NAME'
...
DB.subscriber[0].nested.subscriber[0].event[0].condition[0].equal[0].context[0] = 'by'
...
DB.subscriber[0].nested.subscriber[0].event[0].condition[0].equal[0].value_[0] = 'gunner'
...
DB.subscriber[0].nested.subscriber[0].event[0].count[0].value_ = 2
...
DB.subscriber[0].nested.subscriber[1].client.description.locale = 'LOBBY_QUESTS_2016_DAILY_097'
DB.subscriber[0].nested.subscriber[1].client.name = Dummy()
DB.subscriber[0].nested.subscriber[1].client.name.locale = 'LOBBY_QUESTS_2017_DAILY_003_NAME'
...
DB.subscriber[0].nested.subscriber[1].event[0].count[0].value_ = 80
DB.subscriber[0].nested.subscriber[1].event[0].name = 'sector.capture.participated'
...
DB.subscriber[0].nested.subscriber[2].client.description.locale = 'LOBBY_QUESTS_EVENT_2017_TEXT_7'
...
DB.subscriber[0].nested.subscriber[2].event[0].context = 'lang.epic'
...
DB.subscriber[0].id = -406486070
DB.subscriber[0].nested.subscriber[0].id = 1027797303
DB.subscriber[0].nested.subscriber[1].id = -1532979402
DB.subscriber[0].nested.subscriber[2].id = 1697532150
DB.subscriber[0].nested.subscriber[0].eventIds = (-104890988, 761754430)
DB.subscriber[0].nested.subscriber[1].eventIds = (-1597458317,)
DB.subscriber[0].nested.subscriber[2].eventIds = (1157441311,)
DB.subscriber[0].nested.subscriber[0].parent = -406486070
DB.subscriber[0].nested.subscriber[1].parent = -406486070
DB.subscriber[0].nested.subscriber[2].parent = -406486070
mapping = {'db': DB,
 'indexes': {'subscriber': {'id': {-406486070: (DB.subscriber[0],),
                                   1027797303: (DB.subscriber[0].nested.subscriber[0],),
                                   -1532979402: (DB.subscriber[0].nested.subscriber[1],),
                                   1697532150: (DB.subscriber[0].nested.subscriber[2],)},
                            'name': {'Do-217M': (DB.subscriber[0],),
                            ...
                            'eventIds': {(-104890988, 761754430): (DB.subscriber[0].nested.subscriber[0],),
                                         (-1597458317,): (DB.subscriber[0].nested.subscriber[1],),
                                         (1157441311,): (DB.subscriber[0].nested.subscriber[2],)},
                            'parent': {-406486070: (DB.subscriber[0].nested.subscriber[0], DB.subscriber[0].nested.subscriber[1], DB.subscriber[0].nested.subscriber[2])}}},
