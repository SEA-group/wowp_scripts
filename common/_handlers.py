# Embedded file name: scripts/common/_handlers.py
"""
...
Handlers.handler[14].ifaceName = 'IStatus'
Handlers.handler[14].module = 'account_helpers.dossier_version_updaters.update1xto2x'
...
Handlers.handler[15].ifaceName = 'IInstalledAmmoBelt'
Handlers.handler[15].module = 'eventhandlers.EventIInstalledAmmoBelt.onIInstalledAmmoBeltEdit'
...
Handlers.handler[16].ifaceName = 'IInstalledEquipment'
Handlers.handler[16].module = 'eventhandlers.upgradePlane.changeEquipment'
...
Handlers.handler[17].eventName[0] = 'edit'
Handlers.handler[17].ifaceName = 'IMessage'
Handlers.handler[17].module = 'eventhandlers.upgradePlane.upgradePlane'
Handlers.handler[17].priority = 0
Handlers.handler[17].scope = 'server'
...
Handlers.handler[18].eventName[0] = 'settocache'
Handlers.handler[18].ifaceName = 'IMessage'
Handlers.handler[18].module = 'eventhandlers.eventIMessage.onIMessageCreate'
Handlers.handler[18].priority = 0
Handlers.handler[18].scope = 'client'
...
Handlers.handler[19].eventName[0] = 'update'
Handlers.handler[19].ifaceName = 'IInstalledCount'
Handlers.handler[19].module = 'eventhandlers.EventIInstalledCE.onIInstalledCEEdit'
...
Handlers.handler[20].ifaceName = 'IInstalledAmmoBelt'
...
Handlers.handler[21].ifaceName = 'IInstalledBomb'
...
Handlers.handler[22].ifaceName = 'IInstalledRocket'
...
Handlers.handler[23].ifaceName = 'IInstalledConsumables'
...
Handlers.handler[24].ifaceName = 'IInstalledEquipment'
...
Handlers.handler[25].ifaceName = 'IDepotCount'
Handlers.handler[25].module = 'eventhandlers.eventChangeIFace.onChangeIDepot'
...
Handlers.handler[26].ifaceName = 'IInstalledAmmoBelt'
...
Handlers.handler[27].ifaceName = 'IInstalledBomb'
...
Handlers.handler[28].ifaceName = 'IInstalledRocket'
...
Handlers.handler[29].ifaceName = 'IInstalledConsumables'
...
Handlers.handler[30].ifaceName = 'IInstalledEquipment'
Handlers.handler[30].module = 'eventhandlers.eventChangeIFace.onChangePlaneDepot'
...
Handlers.handler[31].ifaceName = 'IInstalledAmmoBelt'
...
Handlers.handler[32].ifaceName = 'IInstalledConsumables'
...
Handlers.handler[33].eventName[0] = 'before_edit'
Handlers.handler[33].ifaceName = 'IInstalledEquipment'
Handlers.handler[33].module = 'eventhandlers.eventChangeIFace.onChangeIAccountResources'
Handlers.handler[33].priority = 0
Handlers.handler[33].scope = 'server'
...
Handlers.handler[34].eventName[0] = 'edit'
Handlers.handler[34].ifaceName = 'IRepair'
Handlers.handler[34].module = 'eventhandlers.refreshCarouselPlane.refreshCarouselPlane'
Handlers.handler[34].priority = 0
Handlers.handler[34].scope = 'client'
...
Handlers.handler[35].eventName[0] = 'before_edit'
Handlers.handler[35].ifaceName = 'IDepotCount'
Handlers.handler[35].module = 'eventhandlers.eventChangeIFace.onChangeIAccountResources'
...
Handlers.handler[36].eventName[0] = 'market'
Handlers.handler[36].ifaceName = 'IDepotCount'
Handlers.handler[36].module = 'eventhandlers.EventMarket.onBuySell'
...
Handlers.handler[37].eventName[0] = 'before_edit'
Handlers.handler[37].ifaceName = 'IPlaneCrew'
Handlers.handler[37].module = 'eventhandlers.upgradePlane.onChangePlaneCrewMember'
Handlers.handler[37].priority = 0
Handlers.handler[37].scope = 'server'
...
Handlers.handler[38].eventName[0] = 'edit'
Handlers.handler[38].ifaceName = 'IPlaneCrew'
Handlers.handler[38].module = 'eventhandlers.planeCrewEventHandler.onEditPlaneCrew'
...
Handlers.handler[39].eventName[0] = 'settocache'
Handlers.handler[39].ifaceName = 'IPlaneCrew'
Handlers.handler[39].module = 'eventhandlers.planeCrewEventHandler.onSetToCachePlaneCrew'
Handlers.handler[39].priority = 0
Handlers.handler[39].scope = 'client'
...
Handlers.handler[40].ifaceName = 'IInterface'
Handlers.handler[40].module = 'eventhandlers.errorCommonHandlers.onNotFound'
...
Handlers.handler[41].eventName[0] = 'view_error'
Handlers.handler[41].eventName.insert(1, None)
Handlers.handler[41].eventName[1] = 'add_error'
Handlers.handler[41].eventName.insert(2, None)
Handlers.handler[41].eventName[2] = 'delete_error'
Handlers.handler[41].eventName.insert(3, None)
Handlers.handler[41].eventName[3] = 'edit_error'
Handlers.handler[41].ifaceName = 'ISquadMember'
Handlers.handler[41].module = 'eventhandlers.errorSquadMemberHandlers.onNotFound'
Handlers.handler[41].priority = 0
Handlers.handler[41].scope = 'server'
...
Handlers.handler[42].eventName[0] = 'view'
Handlers.handler[42].ifaceName = 'IPlayerSummaryStats'
Handlers.handler[42].module = 'eventhandlers.IPlayerStatsEventHandler.onPlayerStatsView'
...
Handlers.handler[43].eventName[0] = 'edit'
Handlers.handler[43].ifaceName = 'ICrewMember'
Handlers.handler[43].module = 'eventhandlers.crewMemberEventHandler.onEditCrewMember'
...
Handlers.handler[44].eventName[0] = 'settocache'
Handlers.handler[44].ifaceName = 'ICrewMember'
Handlers.handler[44].module = 'eventhandlers.crewMemberEventHandler.onSetToCacheCrewMember'
...
Handlers.handler[45].ifaceName = 'IQuestList'
Handlers.handler[45].module = 'eventhandlers.onChangedQuestList.onChangedQuestList'
...
Handlers.handler[46].ifaceName = 'IExperience'
Handlers.handler[46].module = 'eventhandlers.onChangeExperience.onChangeExperience'
...
Handlers.handler[47].eventName[0] = 'edit'
Handlers.handler[47].eventName.insert(1, None)
Handlers.handler[47].eventName[1] = 'view'
Handlers.handler[47].ifaceName = 'IRent'
Handlers.handler[47].module = 'eventhandlers.onRentEvent.onRentEvent'
...
Handlers.handler[48].eventName[0] = 'delete'
Handlers.handler[48].ifaceName = 'IRequestsLocker'
Handlers.handler[48].module = 'eventhandlers.onRequestsLocker.onRequestsLocker'
...
Handlers.handler[49].eventName.insert(1, None)
Handlers.handler[49].eventName[1] = 'view'
Handlers.handler[49].ifaceName = 'IGameModesParams'
Handlers.handler[49].module = 'eventhandlers.onGameModesParams.onGameModesParams'
...
Handlers.handler[50].ifaceName = 'IIGR'
Handlers.handler[50].module = 'eventhandlers.onIGRChanged.onIGRChanged'
...
Handlers.handler[51].ifaceName = 'IClanMembers'
Handlers.handler[51].module = 'eventhandlers.clanEvents.onClanMembersChanged'
...
Handlers.handler[52].eventName[0] = 'edit'
Handlers.handler[52].eventName.insert(1, None)
Handlers.handler[52].eventName[1] = 'view'
Handlers.handler[52].ifaceName = 'IClanMember'
Handlers.handler[52].module = 'eventhandlers.clanEvents.onClanMemberInfo'
...
Handlers.handler[53].eventName[0] = 'view'
Handlers.handler[53].eventName.insert(1, None)
Handlers.handler[53].eventName[1] = 'edit'
Handlers.handler[53].ifaceName = 'IClanMotto'
Handlers.handler[53].module = 'eventhandlers.clanEvents.onClanMotto'
...
Handlers.handler[54].eventName.insert(1, None)
Handlers.handler[54].eventName[1] = 'view'
Handlers.handler[54].ifaceName = 'IClanInfoShort'
Handlers.handler[54].module = 'eventhandlers.clanEvents.onClanShortInfo'
...
Handlers.handler[55].eventName[0] = 'edit'
Handlers.handler[55].ifaceName = 'IHangarSpacesHash'
Handlers.handler[55].module = 'eventhandlers.onHangarSpacesHashChanged.onHangarSpacesHashChanged'
...
Handlers.handler[56].eventName.insert(1, None)
Handlers.handler[56].eventName[1] = 'edit'
Handlers.handler[56].eventName.insert(2, None)
Handlers.handler[56].eventName[2] = 'delete'
Handlers.handler[56].ifaceName = 'IPlaneBirthday'
Handlers.handler[56].module = 'eventhandlers.planeBirthdayEvents.onPlaneBirthdayChanged'
...
Handlers.handler[57].eventName[0] = 'edit'
Handlers.handler[57].ifaceName = 'IActiveEvents'
Handlers.handler[57].module = 'eventhandlers.serverEvents.onEventsChanged'
...
Handlers.handler[58].eventName[0] = 'add_prediction'
Handlers.handler[58].ifaceName = 'IClientPrediction'
Handlers.handler[58].module = 'eventhandlers.predictionEvents.onAddPrediction'
...
Handlers.handler[59].ifaceName = 'IWarActionState'
Handlers.handler[59].module = 'eventhandlers.EventWarAction.onStateEdit'
...
Handlers.handler[60].eventName[0] = 'edit'
Handlers.handler[60].ifaceName = 'IWarActionFraction'
Handlers.handler[60].module = 'eventhandlers.EventWarAction.onFractionEdit'
...
Handlers.handler[61].eventName[0] = 'view'
Handlers.handler[61].eventName.insert(1, None)
Handlers.handler[61].eventName[1] = 'edit'
Handlers.handler[61].ifaceName = 'IWarActionForce'
Handlers.handler[61].module = 'eventhandlers.EventWarAction.onWarActionForce'
...
Handlers.handler[62].eventName[0] = 'edit'
Handlers.handler[62].eventName.insert(1, None)
Handlers.handler[62].eventName[1] = 'view'
Handlers.handler[62].ifaceName = 'IRepair'
Handlers.handler[62].module = 'eventhandlers.onRepair.onRepair'
...
Handlers.handler[63].eventName.insert(1, None)
Handlers.handler[63].eventName[1] = 'view'
Handlers.handler[63].eventName.insert(2, None)
Handlers.handler[63].eventName[2] = 'settocache'
Handlers.handler[63].ifaceName = 'IActivities'
Handlers.handler[63].module = 'eventhandlers.onActivities.onActivitiesUpdate'
Handlers.handler[63].priority = 0
Handlers.handler[63].scope = 'client'