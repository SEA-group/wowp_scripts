...
class SplineMovementStrategy(MovementStrategyBaseClass):
    ...
    def __init__(self, owner, splineName, startPosPrc):
        ...
        self._matrixProvider = spline and BigWorld.SplineMatrixProvider(self._owner.curStrategyStartTime, self._owner.curStrategyPausedAt, spline, startPosPrc * spline.totalTime()) or None
