# Embedded file name: ./../bigworld/bin/compiled/res/scripts\common\_crewnations_data.py
"""
...
CrewNations.crewunique[0].group = consts.CREW_GROUP.UNQIUE_FEMALE
...
CrewNations.crewunique[0].upgradeType = 2
...
CrewNations.crewunique[1].group = consts.CREW_GROUP.UNQIUE_FEMALE
...
CrewNations.crewunique[1].upgradeType = 2
...
CrewNations.crewunique[2].group = consts.CREW_GROUP.UNQIUE_FEMALE
...
CrewNations.crewunique[2].upgradeType = 2
CrewNations.crewunique.insert(3, None)
CrewNations.crewunique[3] = Dummy()
CrewNations.crewunique[3].aboveMainExp = 632000
CrewNations.crewunique[3].bodyType = 'unique'
CrewNations.crewunique[3].firstName = 2
CrewNations.crewunique[3].group = consts.CREW_GROUP.DUNKIRK
CrewNations.crewunique[3].iconIndex = 2
CrewNations.crewunique[3].lastName = 2
CrewNations.crewunique[3].mainExp = 100000
CrewNations.crewunique[3].planeID = 1595
CrewNations.crewunique[3].rank = 5
CrewNations.crewunique[3].specialization = SpecializationEnum.PILOT
CrewNations.crewunique[3].subSpecialization = 4
CrewNations.crewunique[3].uniqueIndex = 4
CrewNations.crewunique[3].upgradeType = 3
CrewNations.crewunique.insert(4, None)
CrewNations.crewunique[4] = Dummy()
CrewNations.crewunique[4].aboveMainExp = 632000
CrewNations.crewunique[4].bodyType = 'unique'
CrewNations.crewunique[4].firstName = 1
CrewNations.crewunique[4].group = consts.CREW_GROUP.DUNKIRK
CrewNations.crewunique[4].iconIndex = 1
CrewNations.crewunique[4].lastName = 1
CrewNations.crewunique[4].mainExp = 100000
CrewNations.crewunique[4].planeID = 5593
CrewNations.crewunique[4].rank = 5
CrewNations.crewunique[4].specialization = SpecializationEnum.PILOT
CrewNations.crewunique[4].subSpecialization = 5
CrewNations.crewunique[4].uniqueIndex = 5
CrewNations.crewunique[4].upgradeType = 3
CrewNationsDB = None
CrewUniqueDB = None
