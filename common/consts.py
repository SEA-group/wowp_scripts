...
SHAKING_PROFILES_PATH = DB_PATH + 'shaking_parts_profiles.xml'
...
HUD_PLANE_SCHEME_PATH = DB_HUD_PATH + 'planeSchemes/'
LANDSCAPE_PATH = 'maps/landscape/'
LANDSCAPE_MATERIALS_PATH = LANDSCAPE_PATH + 'materialsid.xml'
AC_GAME_MODE_PRESETS_PATH = DB_PATH + 'ACGameModePresets/'
AC_SECTOR_PRESETS_PATH = DB_PATH + 'ACSectorPresets/'
BASES_PATH = DB_PATH + 'bases/'
TURRETS_PATH = DB_PATH + 'turrets/'
SOUND_SETTINGS_PATH = DB_PATH + 'sound_settings.xml'
FAST_COMMANDS_SETTINGS_PATH = DB_PATH + 'fast_commands.xml'
CAMERA_MISC_PATH = DB_PATH + 'camera_misc.xml'
NOT_AVAILABLE = 'n/a'
AC_GAME_MODE_HUD_PLANE_HINT_PATH = DB_PATH + 'Hud/'
...
class PLANE_TYPE():
    ...
    @staticmethod
    def toStr(value):
        return next((k for k, v in PLANE_TYPE.__dict__.iteritems() if v == value), '')
...
PLANE_TYPE_NAME_REVERSED = {v:k for k, v in PLANE_TYPE_NAME.items()}
MIN_BOMB_TARGET_SIZE = 10.0
MAX_BOMB_TARGET_SIZE = 200.0
BOMB_Z_SCATTER_SCALING = 0.0
AIR_RESISTANCE = 0.01
BOMBER_BOMB_DISPERSION_CFC = 0.5
AIR_RESISTANCE_CFC = {PLANE_TYPE.BOMBER: 8,
 PLANE_TYPE.ASSAULT: 10}
BOMB_ACCELERATION_CFC = {PLANE_TYPE.BOMBER: 5}
BOMB_TARGET_VIEW_HEIGHT_RANGE = {PLANE_TYPE.BOMBER: (200, 6000)}
DEFAULT_MIN_FLIGHT_HEIGHT = 5.0
DEFAULT_MAX_FLIGHT_HEIGHT = 2000.0
BOMB_PITCH_ROTATE_SPEED = 0.2 * math.pi
BOMB_YAW_ROTATE_SPEED = 2.0 * math.pi
...
AUTOGIDER_ANGLE_SCALE = 1.0
AUTOGUIDER_SCALE_MAXDIST = 0.5
AUTOGUIDER_SCALE_MINDIST = 1.5
AUTOGUIDER_ANGLE_GROUND = 1.5 / 57
AUTOGUIDER_SMOOTH_ANGLE = 0.2
AUTOGUIDER_FULL_POWER_ANGLE = 0.2
AUTOGUIDER_SMOOTH_POWER = 1.0
AUTOGUIDER_EDGE_MAX = 1.0
AUTOGUIDER_EDGE_MIN = 0.01
AUTOGUIDER_ANGULAR_MIN_PLATO = math.radians(30.0)
AUTOGUIDER_ANGULAR_MAX_PLATO = math.radians(80.0)
AUTOGUIDER_ANGULAR_MIN_EFFECT = 0.75
DEFAULT_LATENCY = 0.1
...
QA_ACCOUNT_ENABLED = True and config_consts.IS_DEVELOPMENT
...
class ARENA_UPDATE():
    ...
    UPDATE_AC_POINTS = 32
    AC_ACTION_MESSAGE = 33
    AC_SECTORS_STATUS = 34
    AC_BATTLE_EVENT = 35
    AC_GAME_TICK = 36
    AC_ROCKET_V2_LAUNCHED = 37
    AC_ROCKET_V2_HIT_TARGET = 38
    AC_BOMBER_IN_WAVE_DIED = 44
    AC_BOMBER_DISPATCHER_TARGET_SECTOR_CHANGED = 45
    AC_ROCKET_V2_TARGET_OBJECT_CHANGED = 51
    ECONOMIC_EVENTS = 46
    ECONOMIC_DEBUG_INFO = 47
...
class MESSAGE_TYPE():
    ...
    WINDOW_WARCACHE_SECRET_SANTA = 272
    BUY_PACK = 280
    BUY_PACK_INFO = 281
    ...
    ADD_SLOT = 285
    ADD_FREECLICK = 286
    BUY_DIRECTIVE_INFO = 287
    WINDOW_ADVERTISING_3YEAR_PLANES = 290
    BOMBER_ASSEMBLED = 300
    WINDOW_BOMBER_ACTION_ADVERTISING = 301
    ...
    WINDOW_ADVERTISING_DUNKERK = 320
    BATTLE_NEUTRAL_WARNING = 460
...
DEFAULT_MODULE_GROUPS_ORDER_BY_TYPE = {UPGRADE_TYPE.PLANER: 0,
 ...
 'slot_5': 13,
 'slot_6': 14}
MODULE_GROUP_NAME = {'turret_front': 'turret_front_description',
 'turret_upper': 'turret_upper_description',
 'turret_lower': 'turret_lower_description',
 'turret_side': 'turret_side_description',
 'turret_rear': 'turret_rear_description'}
MODULE_GROUP_NAME.update(UPGRADE_TYPE.DESCRIPTION_MAP)
MAX_PARENT_UPGRADES_CHECK_DEPTH = 10
PREBATTLE_MAPID_UNDEFINED_FILTER = []
PREBATTLE_MAPID_FILTER_LIMIT = 32
...
class TRAINING_ROOM_REASON():
    ...
    USER_LIMIT = 1
    NOT_READY = 2
    FAILED_TO_CREATE_ARENA = 3
    ERROR_MESSAGE = ['TRAINING_ROOMS_MSG_ERROR_ROOM_DELETED',
     'TRAINING_ROOMS_MSG_ERROR_USER_LIMIT',
     'TRAINING_ROOMS_MSG_ERROR_NOT_READY',
     'TRAINING_ROOMS_MSG_ERROR_FAILED_TO_CREATE_ARENA']
...
class BATTLE_MODE():
    ...
    SNIPER_MODE = 8
    OVERVIEW_MODE = 16
    ALL = COMBAT_MODE | ASSAULT_MODE | GUNNER_MODE | SNIPER_MODE
...
class FIRE_POWER():
    ...
    ETALON_BULLET_FLY_DIST = 500.0 * WORLD_SCALING
...
def calculateGunDPS(powerType, shotData, gunDescription, dispersionAngle, recoilDispersion, overheatTime):
    bulletMaxDistMultiplier = 0.8 + 0.2 * (gunDescription.bulletFlyDist / (500.0 * WORLD_SCALING)) ** 0.5
    alphaStrikeMultiplier = 1.0 + 30.0 / gunDescription.RPM
    totalDPS = gunDescription.DPS * alphaStrikeMultiplier * bulletMaxDistMultiplier
    return totalDPS
...
class AIRCRAFT_CHARACTERISTIC():
    ...
    DIVE_SPEED = 11
    MANEUVERABILITY = 12
    AVERAGE_TURN_TIME = 13
    ROLL_MANEUVERABILITY = 14
    OPTIMAL_MANEUVER_SPEED = 15
    STALL_SPEED = 16
    ALT_PERFORMANCE = 17
    OPTIMAL_HEIGHT = 18
    RATE_OF_CLIMB = 19
...
CHARACTERISTICS_LOCALIZATION_MAP = {AIRCRAFT_CHARACTERISTIC.HEALTH: 'MARKET_AIRPLANE_HEALTH',
 ...
 AIRCRAFT_CHARACTERISTIC.DURABILITY: 'MODULES_CHARACTERISTICS_DURABILITY',
 AIRCRAFT_CHARACTERISTIC.SHELLS: 'LOBBY_SHOP_HEADER_ASSAULT_WEAPONS'}
SPECS_KEY_MAP = {AIRCRAFT_CHARACTERISTIC.HEALTH: 'hp',
 ...
 AIRCRAFT_CHARACTERISTIC.DURABILITY: 'hp',
 AIRCRAFT_CHARACTERISTIC.SHELLS: 'shellsDPS'}
MAIN_CHARACTERISTICS_LIST = [AIRCRAFT_CHARACTERISTIC.GUNS_FIRE_POWER,
 AIRCRAFT_CHARACTERISTIC.SHELLS,
 AIRCRAFT_CHARACTERISTIC.HEALTH,
 AIRCRAFT_CHARACTERISTIC.SPEED,
 AIRCRAFT_CHARACTERISTIC.MANEUVERABILITY,
 AIRCRAFT_CHARACTERISTIC.ALT_PERFORMANCE]
SPECS_BOUNDARIES = {AIRCRAFT_CHARACTERISTIC.HEALTH: (70, 3100),
 AIRCRAFT_CHARACTERISTIC.SPEED: (190, 1200),
 AIRCRAFT_CHARACTERISTIC.MANEUVERABILITY: (100, 1200),
 AIRCRAFT_CHARACTERISTIC.ALT_PERFORMANCE: (300, 3000),
 AIRCRAFT_CHARACTERISTIC.GUNS_FIRE_POWER: (30, 2000),
 AIRCRAFT_CHARACTERISTIC.SHELLS: (9, 830)}
ADDITIONAL_CHARACTERISTICS_PARENTS_MAP = {AIRCRAFT_CHARACTERISTIC.DURABILITY: AIRCRAFT_CHARACTERISTIC.HEALTH,
 ...
 AIRCRAFT_CHARACTERISTIC.RATE_OF_CLIMB: AIRCRAFT_CHARACTERISTIC.ALT_PERFORMANCE,
 AIRCRAFT_CHARACTERISTIC.OPTIMAL_MANEUVER_SPEED: AIRCRAFT_CHARACTERISTIC.MANEUVERABILITY,
 ...
 AIRCRAFT_CHARACTERISTIC.STALL_SPEED: AIRCRAFT_CHARACTERISTIC.MANEUVERABILITY,
 AIRCRAFT_CHARACTERISTIC.GUN_LIST: AIRCRAFT_CHARACTERISTIC.GUNS_FIRE_POWER,
 AIRCRAFT_CHARACTERISTIC.TURRET_LIST: AIRCRAFT_CHARACTERISTIC.GUNS_FIRE_POWER,
 AIRCRAFT_CHARACTERISTIC.OPTIMAL_HEIGHT: AIRCRAFT_CHARACTERISTIC.ALT_PERFORMANCE,
 AIRCRAFT_CHARACTERISTIC.BOMB_LIST: AIRCRAFT_CHARACTERISTIC.SHELLS,
 AIRCRAFT_CHARACTERISTIC.ROCKET_LIST: AIRCRAFT_CHARACTERISTIC.SHELLS}
CHARACTERISTICS_HINTS_MAP = {AIRCRAFT_CHARACTERISTIC.HEALTH: 'TOOLTIP_HANGAR_DURABILITY',
 AIRCRAFT_CHARACTERISTIC.MASS: None,
 ...
 AIRCRAFT_CHARACTERISTIC.GROUND_MAX_SPEED: None,
 AIRCRAFT_CHARACTERISTIC.HEIGHT_MAX_SPEED: None,
 AIRCRAFT_CHARACTERISTIC.OPTIMAL_HEIGHT: None,
 AIRCRAFT_CHARACTERISTIC.ALT_PERFORMANCE: 'TOOLTIP_HANGAR_ALTITUDE',
 AIRCRAFT_CHARACTERISTIC.DIVE_SPEED: None,
 AIRCRAFT_CHARACTERISTIC.STALL_SPEED: None,
 AIRCRAFT_CHARACTERISTIC.RATE_OF_CLIMB: None,
 AIRCRAFT_CHARACTERISTIC.AVERAGE_TURN_TIME: None,
 AIRCRAFT_CHARACTERISTIC.OPTIMAL_MANEUVER_SPEED: None,
 AIRCRAFT_CHARACTERISTIC.ROLL_MANEUVERABILITY: None,
 AIRCRAFT_CHARACTERISTIC.CONTROLLABILITY: None,
 AIRCRAFT_CHARACTERISTIC.DURABILITY: None,
 AIRCRAFT_CHARACTERISTIC.SHELLS: 'TOOLTIP_HANGAR_BOMB_AND_ROCKETS'}
DEFAULT_CHARACTERISTICS_STATE = 1
...
class DB_MODULE_NAMES():
    ...
    PLANES_FOR_TOKENS = '_planesForTokens'
...
class DAMAGE_REASON():
    ...
    NONE = 12
    TREES = 13
    AC_ROCKET_V2_EXPLOSION = 14
    AC_SECTOR_CAPTURE_SUICIDE = 15
    DAMAGE_FROM_WEAPON = (BULLET,
     COMMON_EXPLOSION,
     BOMB_EXPLOSION,
     ROCKET_EXPLOSION,
     AA_EXPLOSION)
    DAMAGE_FROM_SURFACE = (OBSTACLE, TERRAIN, WATER)
...
PREMIUM_ADD_TIME_LIMIT = 2 * PREMIUM_TIME_LIMIT
...
class GAME_OPTIONS_STATS():
    ...
    CMD_GUNNER_MODE = 129
    CMD_GO_TO_BATTLE = 130
    CMD_GO_TO_SPECTATOR = 131
    CMD_GO_BACK = 132
    CMD_RADAR_ZOOM_IN = 133
    CMD_RADAR_ZOOM_OUT = 134
    CMD_SKIP_OUTRO = 138
    CMD_GO_TO_TACTICAL_SPECTATOR = 139
    ROLL_AXIS = 200
    INVERT_ROLL = 201
...
RADAR_STATES = ['minimap', 'minimapRadar', 'radar']
RADAR_SIZES = ['L', 'M', 'S']
RADAR_LOCK_ROTATION = ['RADAR', 'PLAYER']
ATTITUDES_STATES = ['planeMode', 'cameraMode']
...
class SKILL_EVENT():
    ...
    PILOT_S_LAST_SPURT_START = 26
    PILOT_S_LAST_SPURT_END = 27
...
class ShakeConsts():
    slowOscillationHighSpeedPeriod = 1.1
    slowOscillationLowSpeedPeriod = 2.1
    fastOscillationPeriod = 0.2
    fastOscillationLowSpeedAmplitude = 0.35
    fastOscillationHighSpeedAmplitude = 0.75
    fadeTime = 2.0
    interpolationFunc = 'EaseInOutCubic'
...
class SECTOR_LOGIC_STATE():
    NEUTRAL = 0
    ALLY = 1
    ENEMY = 2


class SECTOR_GAMEPLAY_TYPE():
...
class SECTOR_LEVEL_TYPE():
    """Level types for Arena Conquest sectors
    """
    FIELDCAMP = 'fieldcamp'
    RUNWAY = 'runway'
    COMMANDCENTER = 'commandcenter'
...
class SECTOR_GEOMETRY_TYPE():
    """AC sector geometry type
    """
    CIRCLE = 'circle'
    POLYGON = 'polygon'
    ALL = (CIRCLE, POLYGON)
...
class GroundTurretTypes():
    """Ground turret types
    """
    RegularTurret = 1
    HighAltitudeTurret = 2


class ACNPCTypes():
    """AreaConquest NPC player types
    """
    Bomber = 1
    Defender = 2
...
class SPEEDOMETER_LOGICAL_STATES():
    STALL = 0
    STALL_DANGER = 1
    TOO_SLOW = 2
    OPTIMAL = 3
...
class SpeedometerData():
    ...
    def __init__(self, stateRanges, diveSpeed):
        """
        @type stateRanges   : dict[int, tuple[float, float]]
        @type diveSpeed     : float
        """
        self.stateRanges = stateRanges
        self.diveSpeed = diveSpeed

    def __str__(self):
        return str(self._beautifyRanges()) + ', ' + str(round(self.diveSpeed, 2))

    def _beautifyRanges(self):
        return {k:(round(start, 2), round(end, 2)) for k, (start, end) in self.stateRanges.iteritems()}
...
class AIR_STRIKE_WAVE_STATE():
    """Air strike wave state enum
    """
    INTRO_FLIGHT = 1
    ATTACK_NOTIFIED = 2
    ATTACK_IN_PROGRESS = 3
    OUTRO_FLIGHT = 4
    BOMBS_DROPPED = 5
    ACTIVE_STATES = (INTRO_FLIGHT, ATTACK_NOTIFIED, ATTACK_IN_PROGRESS)