# Embedded file name: ./../bigworld/bin/compiled/res/scripts\common\_adapters.py
"""
...
Adapters.adpater[213].obtype[1] = 'arenaType'
...
Adapters.adpater[214].obtype[1] = 'arenaType'
...
Adapters.adpater[243].ifacename = 'ISSEQuestsList'
Adapters.adpater[243].module = 'adapters.ISSEQuests.ISSEQuestsListAdapter'
...
Adapters.adpater[244].ifacename = 'ISSEQuestInfo'
Adapters.adpater[244].module = 'adapters.ISSEQuests.ISSEQuestInfoAdapter'
Adapters.adpater[244].obtype = []
Adapters.adpater[244].obtype.insert(0, None)
Adapters.adpater[244].obtype[0] = 'quest'
Adapters.adpater.insert(245, None)
Adapters.adpater[245] = Dummy()
Adapters.adpater[245].ifacename = 'ISSEQuestState'
Adapters.adpater[245].module = 'adapters.ISSEQuests.ISSEPlayerQuestStateAdapter'
Adapters.adpater[245].obtype = []
Adapters.adpater[245].obtype.insert(0, None)
Adapters.adpater[245].obtype[0] = 'quest'
Adapters.adpater.insert(246, None)
Adapters.adpater[246] = Dummy()
Adapters.adpater[246].ifacename = 'ISSEQuestState'
Adapters.adpater[246].module = 'adapters.ISSEQuests.ISSEPlaneQuestStateAdapter'
Adapters.adpater[246].obtype = []
Adapters.adpater[246].obtype.insert(0, None)
Adapters.adpater[246].obtype[0] = 'quest'
Adapters.adpater[246].obtype.insert(1, None)
Adapters.adpater[246].obtype[1] = 'plane'
Adapters.adpater.insert(247, None)
Adapters.adpater[247] = Dummy()
Adapters.adpater[247].ifacename = 'IPlaneCharacteristicsBoundaries'
Adapters.adpater[247].module = 'adapters.IConfigSpecsAdapter.IPlaneCharacteristicsGlobalBoundariesAdapter'
Adapters.adpater[247].obtype = []
Adapters.adpater[247].obtype.insert(0, None)
Adapters.adpater[247].obtype[0] = 'account'
Adapters.adpater.insert(248, None)
Adapters.adpater[248] = Dummy()
Adapters.adpater[248].ifacename = 'IPlaneCharacteristicsBoundaries'
Adapters.adpater[248].module = 'adapters.IConfigSpecsAdapter.IPlaneCharacteristicsBoundariesAdapter'
Adapters.adpater[248].obtype = []
Adapters.adpater[248].obtype.insert(0, None)
Adapters.adpater[248].obtype[0] = 'plane'
Adapters.adpater.insert(249, None)
Adapters.adpater[249] = Dummy()
Adapters.adpater[249].ifacename = 'IPlaneCharacteristicsConstants'
Adapters.adpater[249].module = 'adapters.IConfigSpecsAdapter.IPlaneCharacteristicsConstantsAdapter'
...
Adapters.adpater[250].ifacename = 'IPlaneCharacteristicsDefaultState'
Adapters.adpater[250].module = 'adapters.IConfigSpecsAdapter.IPlaneCharacteristicsDefaultStateAdapter'
