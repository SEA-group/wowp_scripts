...
class OPERATION_RETURN_CODE:
    ...
    FAILURE_FREEEXP_ADD_ONLY = 30
    FAILURE_MAX_SOLD_PLANES_PER_DAY_REACHED = 31
    FAILURE_NO_ENOUGH_TICKETS = 32
    FAILURE_GOLD_PRICE_NOT_SUPPORTED = 33
    FAILURE_FREEEXP_RATIO = 34
    FAILURE_BUY_PREMIUM_TIMEINDEX = 35
    FAILURE_BUY_PREMIUM_LIMIT = 36
    FAILURE_NO_ENOUGH_FREECLICKS = 37
    FAILURE_WARCACHE_DISABLED = 38
    FAILURE_NO_ENOUGH_QUESTCHIPS = 39
    START_EXAM = 50
    RESTART_LESSON = 51
    NEXT_LESSON = 52
    ...
    FAILURE_WRONG_KWARG_VALUE = 113
    FAILURE_FORBIDDEN_FOR_OTHER_ACCOUNT = 114
    FAILURE_OBJECT_NOT_FOUND = 115
    FAILURE_OPERATION_FINANCE_GOLD_LIMIT_EXCEEDED = 116
    FAILURE_BUY_UNAVAILABLE = 117
    FAILURE_WRONG_ITEM_ID = 118
    FAILURE_OPERATIONS_COUNT_LIMIT_EXCEEDED = 119
    FAILURE_UNEXPECTED_KWARGS = 120
    ...
    FAILURE_CREW_FAILED_TO_ADD_XP = 229
    FAILURE_BARRACKS_CROWDED = 230
    FAILURE_CREWMEMBER_NOT_ON_PLANE = 231
    FAILURE_SKILL_POINTS_COUNT = 232
    FAILURE_EXP_VALUE = 233
    FAILURE_CREW_EXTRA_PARAM = 234
    ...
    FAILURE_WRONG_PLANES_LIST = 311
    FAILURE_PLANES_LIST_NOT_ELITE = 312
    FAILURE_FORBIDDEN_ADD_NPC_PLANE = 313
    ...
    FAILURE_OPERATION_NOT_FOUND = 1100
    FAILURE_GE_ALREADY_ACTIVATED = 1101
    FAILURE_GE_ALREADY_ADDED = 1102
    FAILURE_GE_SCOPE_MISMATCH = 1103
    FAILURE_VALIDATOR_IS_LAST_AVAILABLE_TO_COMPLETE = 2000
    FAILURE_VALIDATOR_IS_NO_ROOT_QUEST_ACTIVE = 2001
    FAILURE_VALIDATOR_IS_OBJECT_EQUAL_SETTINGS = 2002
    FAILURE_VALIDATOR_IS_PRICE_VALID_FOR_OBJ = 2003
    FAILURE_VALIDATOR_IS_NO_PREV_QUEST_OR_PREV_HAS_PROGRESS = 2004
    FAILURE_VALIDATOR_IS_PARENT_MARATHON_ROOT_QUEST = 2005
...
_OPERATION_RETURN_CODE_DESCRIPTIONS = {OPERATION_RETURN_CODE.SUCCESS: 'OK',
 ...
 OPERATION_RETURN_CODE.FAILURE_WRONG_KWARG_TYPE: "Wrong '{name}' kwarg type supplied, expected '{expected}', got '{got}'",
 OPERATION_RETURN_CODE.FAILURE_WRONG_KWARG_VALUE: "Wrong '{name}' kwarg value supplied: got={got}, expected={expected}",
 OPERATION_RETURN_CODE.FAILURE_UNEXPECTED_KWARGS: 'Unexpected kwargs: {kwargs}',
 OPERATION_RETURN_CODE.FAILURE_FORBIDDEN_FOR_OTHER_ACCOUNT: "Forbidden for other account, expected id '{expected}', got id '{got}'",
 OPERATION_RETURN_CODE.FAILURE_OBJECT_NOT_FOUND: '{obType} with id={obID} not found',
 ...
 OPERATION_RETURN_CODE.FAILURE_WRONG_ITEM_ID: 'Wrong itemID: {idTypeList}',
 ...
 OPERATION_RETURN_CODE.FAILURE_OPERATION_FINANCE_GOLD_LIMIT_EXCEEDED: 'Operation finance limit exceeded: {gold}',
 OPERATION_RETURN_CODE.FAILURE_NOT_ENOUGH_EXP: 'Not enough exp {exp} has {allowExp} on plane {planeID}',
 OPERATION_RETURN_CODE.FAILURE_OPERATIONS_COUNT_LIMIT_EXCEEDED: 'Count operations is too much count:{count} limit:{limit}',
 ...
 OPERATION_RETURN_CODE.FAILURE_FREEEXP_ADD_ONLY: 'Wallet is closed',
 OPERATION_RETURN_CODE.FAILURE_NO_FREE_SLOT: 'No free hangar slot present',
 OPERATION_RETURN_CODE.FAILURE_FREEEXP_RATIO: 'FreeExp {freeExp} must be in response ratio {ratio}',
 OPERATION_RETURN_CODE.FAILURE_BUY_PREMIUM_TIMEINDEX: 'buyPremium not valid timeindex {timeIndex}',
 OPERATION_RETURN_CODE.FAILURE_BUY_PREMIUM_LIMIT: 'buyPremium out of limit for buy',
 ...
 OPERATION_RETURN_CODE.FAILURE_CREW_FAILED_TO_ADD_XP: 'Failed to add xp(count={count}) for crewmember (id={memberID}).',
 OPERATION_RETURN_CODE.FAILURE_BARRACKS_CROWDED: 'Trying to buy {count} berths when {got} available.',
 OPERATION_RETURN_CODE.FAILURE_CREWMEMBER_NOT_ON_PLANE: 'Crew member(id={memberID}) should be on plane(current planeID={planeID}).',
 OPERATION_RETURN_CODE.FAILURE_SKILL_POINTS_COUNT: 'Wrong count {count} of SP for crew mmember. have to be in range (1 to {maxSP})',
 OPERATION_RETURN_CODE.FAILURE_EXP_VALUE: 'Wrong exp value {exp} for crew mmember.',
 OPERATION_RETURN_CODE.FAILURE_CREW_EXTRA_PARAM: 'Wrong extra params must be used one of then (skillPoints or aboveMainExp)',
 ...
 OPERATION_RETURN_CODE.FAILURE_WRONG_PLANES_LIST: 'Planes {planeIDs} was wrong',
 OPERATION_RETURN_CODE.FAILURE_PLANES_LIST_NOT_ELITE: 'Planes are not elite in list {planeIDs}',
 ...
 OPERATION_RETURN_CODE.FAILURE_UNKNOWN_PACK_ID: 'Unknown packID = {packID}',
 OPERATION_RETURN_CODE.FAILURE_DISABLE_PACK_ID: 'Disable packID = {packID}',
 OPERATION_RETURN_CODE.FAILURE_GE_ALREADY_ACTIVATED: 'Game event object already activated: id={objID}',
 OPERATION_RETURN_CODE.FAILURE_GE_ALREADY_ADDED: 'Game event object already added: id={objID}, type={objType}, group={objGroup}',
 OPERATION_RETURN_CODE.FAILURE_GE_SCOPE_MISMATCH: "Object scope('{objScope}') != storage scope('{storageScope}')"}
